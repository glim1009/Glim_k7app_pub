<template>
  <ContDialog v-model="isOpen" content-class="ui-dialog-full">
              ...
              <div class="coupon-box">
                <div class="coupon-header">
                  <div class="ui-chk-prod">
                    ...
                    <label for="couponChk01" class="align-top" />
                    <!-- thumb-prod-flex -->
              ...
              <div class="coupon-box">
                <div class="coupon-header">
                  <div class="ui-chk-prod">
                    ...
                    <label for="couponChk02" class="align-top" />
                    <!-- thumb-prod-flex -->
                    <div class="thumb-prod-flex">
                      <EThumbProdBox size="lg">
                        <template #thumb>
                ...
                <div class="coupon-cont">
                  ...
                  <ColorBox color="light-gray" size="md" class="prod-sel-before">
                    <RowListWrap>
                      <li class="item-md">
                        <span class="ui-rdo">
    ...
    <template #footer>
      <!-- DESC :: 구독권 한 건이라도 선택 시 [disabled] 속성 제거 -->
