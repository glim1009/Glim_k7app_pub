  ...
  <div class="header-wrapper">
    <div class="header-box">
      <div class="header-left">
        <button v-if="!notBack" class="btn-header-back">
          <EIco name="back" />
        </button>
      ...
      <div v-if="isIconVisible" class="header-right">
        ...
        <NuxtLink v-if="isIconVisible('home')" tag="a" to="/" class="btn-header-util">
          <EIco name="home" />
        </NuxtLink>
        <NuxtLink v-if="isIconVisible('search')" tag="a" to="/search" class="btn-header-util">
          <EIco name="search" />
        </NuxtLink>
        <NuxtLink v-if="isIconVisible('cart')" tag="a" to="/cart" class="btn-header-util cart">
          <EIco name="cart" />
