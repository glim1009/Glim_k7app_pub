  ...
  <ContWrap>
    <ContBox>
              ...
              <div class="thumb-prod-flex">
                ...
                <div class="info-box">
                  <BadgeGroup gap="md">
                    ...
                    <EBadge color="green" size="sm" badge-text="착한택배" />
                    <EBadge color="gray" size="sm" badge-text="일반택배" />
                  </BadgeGroup>
      ...
      <InfoGuideWrap
        ...
        sub-desc="세븐앱에서 진행하는 다양한 이벤트에 참여하시면<br />사용가능한 쿠폰을 받으실 수 있습니다."
      />
      <BtnWrap v-if="isNoData" type="auto-center" size="xl">
        <EBtn tag="a" color="line-gray" to="/event">
