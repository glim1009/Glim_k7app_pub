<template>
                  ...
                  <li class="item-form">
                    <div class="form-field">
                      ...
                      <div class="form-cont">
                        ...
                        <RowListWrap gap="sm">
                          <span class="ui-chk">
                            <input id="demoChk01" type="checkbox" disabled />
                            <label for="demoChk01"><span class="text-md">기본주소지와 동일</span></label>
                          </span>
                        </RowListWrap>
                      </div>
                      ...
                      <div class="form-cont">
                        ...
                        <RowListWrap gap="sm">
                          <span class="ui-chk">
                            ...
                            <label for="demoChk02"><span class="text-md">주소록에 추가</span></label>
                          </span>
                        </RowListWrap>
                      </div>
                    </div>
                            ...
                            <div class="form-cont">
                              ...
                              <RowListWrap gap="sm">
                                <span class="ui-chk">
                                  ...
                                  <label for="demoChk03"><span class="text-md">기본주소지와 동일</span></label>
                                </span>
                              </RowListWrap>
                            </div>
                          </div>
                            ...
                            <div class="form-cont">
                              ...
                              <RowListWrap gap="sm">
                                <span class="ui-chk">
                                  ...
                                  <label for="demoChk04"><span class="text-md">기본주소지와 동일</span></label>
                                </span>
                              </RowListWrap>
                            </div>
                          </div>
                  ...
                  <li class="item-form">
                    <div class="form-field">
                      ...
                      <div class="form-cont">
                        ...
                        <RowListWrap gap="sm">
                          <span class="ui-chk">
                            <input id="demoChk02" type="checkbox" disabled />
                            <label for="demoChk02"><span class="text-md">주소록에 추가</span></label>
                          </span>
                        </RowListWrap>
                      </div>
  ...
  <!-- pop : 주소록 -->
  <PopDeliveryAddressList v-model:sta="popAddressList" />
  <!-- // pop : 주소록 -->
