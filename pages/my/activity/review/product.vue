    ...
    <ContWrap class="side-zero" in-top="sm">
      <TabWrap class="justify-tab">
        <template #tabs>
          <ul class="tab-list">
            <li class="tab-item">
              <NuxtLink class="tab-link" to="/my/activity/review/product" exact-active-class="is-active">
                <span class="tab-text">작성 가능한 리뷰</span>
              </NuxtLink>
            </li>
            <li class="tab-item">
              <NuxtLink class="tab-link" to="/my/activity/review/product/my" exact-active-class="is-active">
                <span class="tab-text">내가 작성한 리뷰</span>
              </NuxtLink>
            </li>
          </ul>
        </template>
