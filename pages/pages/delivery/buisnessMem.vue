  ...
  <ContWrap>
    <RowListWrap gap="xl">
      <li class="item">
        ...
        <RowListWrap gap="sm" size="sm">
          <li class="dot-text">
            개인사업자만 사업자회원 증빙이 가능합니다.
          </li>
          <li class="dot-text">
            사업자회원 인증은 영업일 기준 약 3~5일이 소요됩니다.
          </li>
          <li class="dot-text">
            일정기간 이용내역이 없거나 부적절한 방식으로 인증된 사실이 발견된 경우 예고 없이 인증이 취소될 수 있습니다
          </li>
        </RowListWrap>
      </li>
      <li class="item">
          ...
          <RowListWrap gap="xl">
            <li class="item-form">
              <div class="form-field">
                <div class="form-title">
                  <div class="ctitle-xs">
                    사업자등록번호<span class="required"><span class="offscreen">필수입력</span></span>
                  </div>
                </div>
                <div class="form-cont">
                  <div class="form-input-group valid-check fail">
                    <EInputBox title="사업자등록번호 입력" placeholder="사업자등록번호를 입력해주세요." />
                    <p class="valid-desc">
                      사업자등록번호를 입력해주세요.
                    </p>
                  </div>
            ...
            <li class="item-form">
              <div class="form-field">
                <div class="form-title">
                  <div class="ctitle-xs">
                    사업자등록증 이미지<span class="required"><span class="offscreen">필수입력</span></span>
                  </div>
                </div>
                <div class="form-cont">
                  <div class="form-input-group valid-check fail">
